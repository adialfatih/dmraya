...
<meta charset="UTF-8">
    ...
    <title>Galleri - DAMAY RAYA SOLUTIONS</title>
...
<body>
        ...
        <div class="navigation">
            ...
            <nav>
                <ul>
                    ...
                    <a href="<?=base_url('galleri');?>"><li class="active">Galeri</li></a>
    ...
    <main>
        <section class="company">
            <div class="galleri-foto">
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/2.png" alt="PILARBOMBA 53 / 106 SC">
                    <span>PILARBOMBA 53 / 106 SC</span>
                </div>
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/3.png" alt="PILARTRUST 100 SC">
                    <span>PILARTRUST 100 SC</span>
                </div>
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/4.png" alt="PILARGOLA 400 SC">
                    <span>PILARGOLA 400 SC</span>
                </div>
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/7.png" alt="PILARZOX 85 / 170 SC">
                    <span>PILARZOX 85 / 170 SC</span>
                </div>
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/8.png" alt="PILARSPIRIT 20 / 147 OD">
                    <span>PILARSPIRIT 20 / 147 OD</span>
                </div>
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/9.png" alt="PILARTEBU 430 SC">
                    <span>PILARTEBU 430 SC</span>PILARMECTIN 53 CS
                </div>
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/10.png" alt="PILARMECTIN 53 CS">
                    <span>PILARMECTIN 53 CS</span>
                </div>
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/11.png" alt="PILARCOBRE 545 SC">
                    <span>PILARCOBRE 545 SC</span>
                </div>
                <div class="imgs" data-hystmodal="#myModal">
                    <img src="<?=base_url('assets/');?>assetss/newImage2/5.png" alt="PILARCHESS 60 WG">
                    <span>PILARCHESS 60 WG</span>
                </div>
                <div class="imgs" data-hystmodal="#myModal">
    ...
    <script src="<?=base_url('assets/');?>assetss/dist/hystmodal.min.js"></script>
    <script>
        function cekbox(){
